...
- 在不把界面做复杂的前提下，补齐 Face ID、共享通知和图片插入
...
- 全局层统一承载忙碌态、Face ID 锁层、编辑器 sheet、设置页 sheet 和错误 alert
- 如果启用了 Face ID，应用打开或回到前台会先要求验证
